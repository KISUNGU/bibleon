/*
  # Correction de la table du dictionnaire

  1. Structure
    - Recréation complète de la table dictionary
    - Support pour l'hébreu et le grec
    - Contraintes et index optimisés

  2. Données
    - Mots de l'Ancien Testament (hébreu)
    - Mots du Nouveau Testament (grec)
    - Gestion des doublons avec des clés uniques composites
*/
