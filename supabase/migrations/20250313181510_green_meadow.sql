/*
  # Mise à jour de la table du dictionnaire biblique

  1. Structure
    - Suppression et recréation de la table dictionary
    - Ajout des colonnes pour les origines hébraïques et grecques
    - Contrainte unique sur (word, testament) au lieu de word seul
    - Index pour la recherche et le filtrage

  2. Données
    - Insertion des définitions pour l'Ancien Testament (hébreu)
    - Insertion des définitions pour le Nouveau Testament (grec)
    - Distinction claire entre les mots similaires des deux testaments
*/
